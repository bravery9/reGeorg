...
*/
    try
    {
        if (Request.HttpMethod == "POST")
        {
            ...
            String socketID = Request.QueryString.Get("socketID");
            if (cmd == "CONNECT")
            {
                try
                {
                    ...
                    if (socketID == null)
                        ...
                        Session.Add(socketID+"socket", sender);
            ...
            else if (cmd == "DISCONNECT")
            {
                ...
                if (socketID == null)
                {
                    ...
                    s = (Socket)Session[socketID+"socket"];
                    Session[socketID+"socket"] = null;
                }
                try {
                    s.Close();
                } catch (Exception ex){
            ...
            else if (cmd == "READ")
            {
                ...
                {
                    int c = 0;
                    int bufSize = int.Parse(Request.QueryString.Get("bufsize"));
